...
import ThreadAndCommentTree from "@/app/admin/components/ThreadAndCommentTree";
...
const Page = async ({ params }: { params: Promise<Params> }) => {
  ...
  console.log("Admin Thread Page accessed for thread ID:", threadId);
  return (
    <main className="flex  flex-col items-center justify-center  mx-auto ">
      <h1 className="text-4xl font-bold  mt-0 mb-5 w-full z-10 text-center">
        Anonymous Bulletin Board Admin
      </h1>
